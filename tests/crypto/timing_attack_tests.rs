...
fn test_signature_timing_independence() {
    ...
    // Generate plusieurs paires de keys
    ...
    // Mesurer le temps de verification pour differentes signatures
    ...
    for (sk, pk) in &keypairs {
        ...
        // Test avec signature modifiee (doit fail en temps constant)
        ...
        // Check that les temps sont similaires (±10%)
    ...
    // Test de variance - doit be similaire
