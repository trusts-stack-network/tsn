...
fn test_nullifier_double_spend_prevention() {
    /// Test critique: un nullifier ne peut be utilise qu'une seule fois
    /// Fail ici = fail economique total (double spend possible)
...
proptest! {
    ...
    fn prop_nullifier_uniqueness(
        ...
        for (i, note_data) in notes.iter().enumerate() {
            ...
            // Chaque nullifier doit be unique
        ...
        // Verifie qu'on ne peut pas reinserer
