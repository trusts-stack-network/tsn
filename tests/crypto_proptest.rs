...
proptest! {
    ...
    fn merkle_root_order_leaves(v in vec(any::<[u8;32]>(), 1..1024)) {
        ...
        // Le root doit be identique quelle que soit l'ordre d'insertion
    ...
    fn commitment_homomorphic(v1: u64, v2: u64) {
        ...
        // On ne checks pas l'homomorphisme reel car la commitment est blindee,
        // mais on s'assure que la fonction ne panique pas sur des valeurs randoms.
