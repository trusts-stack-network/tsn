...
//!
//! Ce module provides des wrappers pratiques pour profiler :
    ...
    F: FnOnce() -> T,
{
    ...
    tracing::debug!(
        ...
        duration_ms = %duration.as_millis(),
        "Generation de preuve ZK profilee"
    );
    ...
    F: FnOnce() -> T,
{
    ...
    tracing::debug!(
        ...
        proof_type = %proof_type,
        duration_ms = %duration.as_millis(),
        "Verification de preuve ZK profilee"
    );
    
    result
}

/// Wrapper generique pour les operations crypto
...
/// Profile une operation d'ecriture DB
...
/// Profile une operation de suppression DB
    ...
    F: FnOnce() -> T,
{
    ...
    tracing::debug!(
        ...
        duration_ms = %duration.as_millis(),
        "Writing batch DB profilee"
    );
    
    result
}

/// Wrapper generique pour les operations DB
    ...
    F: FnOnce() -> T,
{
    ...
    tracing::trace!(
        ...
        data_size = %data_size,
        duration_ms = %duration.as_millis(),
        "Deserialization profilee"
    );
    
    result
}

/// Wrapper generique pour les operations de serialization
...
// ============================================================================
// Fonctions utilitaires pour les types specifiques TSN
// ============================================================================
...
/// Profile la verification d'une transaction complete
