...
// Ces modules not are compiled qu'en mode test or with the feature explicite "vulnerable-demo"
...
// Guard de security : the modules vulnerables not compilent qu'en test/demo (voir cfg ci-dessus)
