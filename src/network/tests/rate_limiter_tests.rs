//! Tests unitaires for the rate limiter TSN
//! 
//! Tests isolated with control total of the temps and of parameters.
...
/// Test basique: a rate limiter fees accepts the requests
#[tokio::test]
...
/// Test: the rate limiter bloque after overflow of the seuil
#[tokio::test]
...
/// Test: the rate limiter resets after 1 seconde
#[tokio::test]
...
/// Test: each pair a son propre bucket
#[tokio::test]
async fn test_rate_limiter_per_peer_isolation() {
    ...
    // Exhausts the quota of the first pair
...
/// Test: handling many simultaneous peers
#[tokio::test]
...
/// Test: comportement with max_requests_per_second = 0
#[tokio::test]
async fn test_rate_limiter_zero_threshold() {
    ...
    // Toutes the requests devraient be blockedes
    assert!(!limiter.check(&addr), "Zero threshold should block all");
}

/// Test: comportement with max_requests_per_second very high
#[tokio::test]
